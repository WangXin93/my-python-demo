...
class Game:
    def __init__(self):
        ...
        self.gameover = self.canvas.create_text(230,230,text = 'Game Over',
                                                font = ('Times',30),state = 'hidden')
        self.sprites = []
        self.running = True
...
class DoorSprite(Sprite):
    def __init__(self,game,photo_image,photo_image2,x,y,width,height):
        Sprite.__init__(self,game)
        self.photo_image = photo_image
...
door = DoorSprite(g,PhotoImage(file = 'door1.gif'),PhotoImage(file = 'door2.gif'),
                  45,50,27,30)
