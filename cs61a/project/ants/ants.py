        ...
        if not self.true_queen:
            ...
            while True:
                if current_place.ant:
                    ...
                    if current_place.ant.container and current_place.ant.ant and current_place.ant.ant not in self.buffed_ants:
